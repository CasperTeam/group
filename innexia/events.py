    ...
    def decorator(func):
        async def wrapper(check):
            ...
            if check.is_group or check.is_private:
                ...
                print("hey dude dont add me in channel")
                return
            if check.is_group:
               if check.chat.megagroup:
                  pass
               else:
                  print("i cant work here please make it a super group ")
                  return
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import innexia.events

        path = Path(f"innexia/modules/{shortname}.py")
        name = "innexia.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["innexia.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "innexia/modules/*.py"
