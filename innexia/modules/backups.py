...
import innexia.modules.sql.notes_sql as sql
from innexia import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from innexia.__main__ import DATA_IMPORT
from innexia.modules.helper_funcs.chat_status import user_admin
from innexia.modules.helper_funcs.alternate import typing_action

# from innexia.modules.rules import get_rules
import innexia.modules.sql.rules_sql as rulessql

# from innexia.modules.sql import warns_sql as warnssql
import innexia.modules.sql.blacklist_sql as blacklistsql
from innexia.modules.sql import disable_sql as disabledsql

# from innexia.modules.sql import cust_filters_sql as filtersql
# import innexia.modules.sql.welcome_sql as welcsql
import innexia.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("innexia{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("innexia{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `innexia-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("innexia{}.backup".format(chat_id))  # Cleaning file
