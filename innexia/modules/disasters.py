...
from innexia.modules.log_channel import gloggable
from telegram import ParseMode, TelegramError, Update
from telegram.ext import CallbackContext, CommandHandler, run_async
from telegram.utils.helpers import mention_html

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "innexia/elevated_users.json")
...
# *Global Blue Text*
#  💞 /gignoreblue*:* <word>*:* Globally ignorea bluetext cleaning of saved word across innexia.
